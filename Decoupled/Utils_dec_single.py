...
class SyntheticDataset():
    def __init__(self, fname, stop, chr_n):
        self.stop=stop-2
        self.fname=fname
        self.key=0
        self.chr_n = chr_n
    def process(self):
        ...
        self.graphs.update({self.chr_n:[Data(edge_index=g.edge_index, nx_graph=nx_clean, nnods=nx_clean.number_of_nodes(), num_nodes=nx_clean.number_of_nodes(), nedges=nedges, fnames=self.fname)]})
